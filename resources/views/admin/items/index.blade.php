                ...
                <table class="min-w-full text-xs sm:text-sm border-collapse">
                    <thead>
                        <tr class="border-b text-[11px] sm:text-xs text-slate-500">
                            ...
                            <th class="py-2 px-2 text-left whitespace-nowrap">Kategori</th>
                            <th class="py-2 px-2 text-left whitespace-nowrap">Harga</th>
                            <th class="py-2 px-2 text-left whitespace-nowrap">Stok</th>
                    ...
                    <tbody>
                            ...
                            <tr class="border-b last:border-b-0">
                                        ...
                                        <div class="w-10 h-10 rounded-lg bg-slate-100 overflow-hidden flex-shrink-0">
                                            @if ($item->path)
                                                <img src="{{ asset('storage/' . $item->path) }}"
                                                    class="w-full h-full object-cover" alt="{{ $item->item }}">
                                            @endif
                                        </div>
                                        <div class="min-w-0">
                                ...
                                <td class="py-2 px-2 align-top text-right whitespace-nowrap">
                                    <a href="{{ route('admin.items.edit', $item) }}"
                                        class="text-indigo-600 hover:underline mr-2 text-xs">
                                        Edit
                                    </a>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="py-4 px-2 text-center text-slate-500">
                                    Belum ada produk.
                                </td>
                            </tr>
                        @endforelse
